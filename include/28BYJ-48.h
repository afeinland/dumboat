...
/* These defines are used by both the controller and the craft.*/
#define     STEPPER_MOTOR_ON                0xFF
#define     STEPPER_MOTOR_OFF               0x00


enum STEPPER_MOTOR_STATE{ON, OFF} stepper_motor_state;
